...
public class PhotonHandler : Photon.MonoBehaviour, IPhotonPeerListener
{
    ...
    public void DebugReturn(DebugLevel level, string message)
    {
        ...
        else if (level == DebugLevel.INFO && PhotonNetwork.logLevel >= NetworkLogLevel.Informational)
        {
            Debug.Log(message);
        }
        else if (level == DebugLevel.ALL && PhotonNetwork.logLevel == NetworkLogLevel.Full)
        {
            Debug.Log(message);
        }
    }
