...
public partial class RTools : InspectorSearch
{
    ...
    protected override void SetupLevel() // resetpos  
    {
    ...
    private void Build()
    {
        ...
        {
            CrDir("t2");
            Debug.Log("build2 " + BuildPipeline.BuildPlayer(new[] { "Assets/materials/empty.unity" }, "t2/asd", BuildTarget.StandaloneWindows, BuildOptions.Development));
