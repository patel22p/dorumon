...
public class HostWindow : WindowBase {
	...
	internal string[] GameMode = new string[] {"Зомби Выживание","Зомби Командная игра","Выживание","Командная игра",};
	internal int iGameMode = 0;
	internal bool focusMap;
	internal string[] Map = new string[] {"none",};
	internal int iMap = 0;
	internal int tabTabControl15;
	internal string pathImage16 = "Images/Image3";
