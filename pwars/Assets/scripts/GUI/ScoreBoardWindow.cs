...
public class ScoreBoardWindow : WindowBase {
	...
	void Wnd1(int id){
		...
		TableHeader = GUI.TextField(new Rect(25f, 54f, 405f, 13f), TableHeader,100, GUI.skin.customStyles[2]);
		}
		...
		sScoreboard_orderby = GUI.BeginScrollView(new Rect(444f, 73f, 111f, 312f), sScoreboard_orderby, new Rect(0,0, 91f, lScoreboard_orderby.Length* 18.9599990844727f));
		int oldScoreboard_orderby = iScoreboard_orderby;
		iScoreboard_orderby = GUI.SelectionGrid(new Rect(0,0, 91f, lScoreboard_orderby.Length* 18.9599990844727f), iScoreboard_orderby, lScoreboard_orderby,1,GUI.skin.customStyles[0]);
