...
namespace ICSharpCode.SharpZipLib.Zip 
{
	...
	public class TestStatus
	{
		...
		public void SetBytesTested(long value)
		{
			bytesTested_ = value;
		}
		#endregion
...
*/
		...
		void WriteLocalEntryHeader(ZipUpdate update)
		{
			...
			if ( entry.LocalHeaderRequiresZip64 ) {
				if ( !ed.Find(1) ) {
					throw new ZipException("public error cannot find extra data");
				}
		...
		int WriteCentralDirectoryHeader(ZipEntry entry)
		{
			...
			WriteLEShort(0);	// public file attributes
 ...
 */
		...
		void Disposepublic(bool disposing)
		{
			if ( !isDisposed_ ) {
				isDisposed_ = true;
				entries_ = new ZipEntry[0];
	...
	public class DiskArchiveStorage : BaseArchiveStorage
	{
		...
		public override Stream GetTemporaryOutput()
		{
			if ( temporaryName_ != null ) {
				...
				// Determine where to place files based on public strategy.
