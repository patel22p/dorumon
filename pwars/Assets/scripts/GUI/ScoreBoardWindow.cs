...
public class ScoreBoardWindow : WindowBase
{
    ...
    void Wnd1(int id)
    {
        ...
        if (vscoreboard_orderby)
        {
            ...
            sScoreboard_orderby = GUI.BeginScrollView(new Rect(434f, 73f, 111f, 312f), sScoreboard_orderby, new Rect(0, 0, 91f, lScoreboard_orderby.Length * 44.9599990844727f));
            int oldScoreboard_orderby = iScoreboard_orderby;
            iScoreboard_orderby = GUI.SelectionGrid(new Rect(0, 0, 91f, lScoreboard_orderby.Length * 44.9599990844727f), iScoreboard_orderby, lScoreboard_orderby, 1, GUI.skin.customStyles[0]);
