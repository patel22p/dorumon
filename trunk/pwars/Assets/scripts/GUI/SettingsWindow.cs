...
public class SettingsWindow : WindowBase {
	...
	public float SaveScreenShots{ get { return PlayerPrefs.GetFloat("SaveScreenShots", 10f); } set { PlayerPrefs.SetFloat("SaveScreenShots", value); } }
	...
	internal string[] GraphicQuality = new string[] {"Fastest","Fast","Simple","Good","Beautifull","Fantastic",};
	internal bool focusScreenSize;
	internal string[] ScreenSize = new string[] {};
	...
	internal string[] RenderSettings = new string[] {"Самый Быстрый","Forward","Deffered",};
	internal int iRenderSettings = -1;
	internal bool focusSaveScreenShots;
	...
	void Wnd1(int id){
		...
		focusWindow = false;
		bool onMouseOver;
		GUI.BeginGroup(new Rect(34.5f, 36f, 463.5f, 284.333f), "");
		GUI.Box(new Rect(0, 0, 463.5f, 284.333f), "");
		...
		GUI.Label(new Rect(30.5f, 237f, 198.2933f, 21.96f), @"Сохранять фотки каждые x секунд");
		GUI.Label(new Rect(357.5f, 162f, 55f, 14f), @"10");
		if(focusSaveScreenShots) { focusSaveScreenShots = false; GUI.FocusControl("SaveScreenShots");}
		GUI.SetNextControlName("SaveScreenShots");
		SaveScreenShots = GUI.HorizontalSlider(new Rect(35.374f, 255f, 179.333f, 14f), SaveScreenShots, 0f, 50f);
		GUI.Label(new Rect(214.706992553711f,255f,40,15),System.Math.Round(SaveScreenShots,1).ToString());
		GUI.EndGroup();
