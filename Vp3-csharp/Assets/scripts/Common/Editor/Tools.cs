...
public class Tools : Editor{
    ...
    [MenuItem("RTools/SetTagForAll")]
    public static void SetTagForAll()
    {
        //var tag = Selection.gameObjects.FirstOrDefault(a => a.tag != "Untagged").tag;
        //Debug.Log(tag);
        foreach (var g in Selection.gameObjects)
            g.tag = Selection.activeGameObject.tag;
    }
    [MenuItem("RTools/SetLoopAnim")]
    public static void SetLoopAnim()
    {        
        Selection.activeGameObject.animation.wrapMode = WrapMode.Loop;
    }
